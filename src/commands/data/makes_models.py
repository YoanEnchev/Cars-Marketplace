makes_models = {
    'AC': [],
    'Abarth': ['124', '595'],
    'Acura': ['ILX', 'Integra', 'Mdx', 'NSX', 'Rdx', 'Rl', 'Rsx', 'Slx', 'TLX', 'Tl', 'Tsx'],
    'Aixam': ['400', '505', '600'],
    ...
    'Citroen': ['2cv', 'Ax', 'Axel', 'Berlingo', 'Bx', 'C - Zero', 'C-Crosser', 'C-Elysee', 'C1', 'C15', 'C2', 'C3', 'C3 Aircross', 'C3 Picasso', 'C3 pluriel', 'C4', 'C4 AIRCROSS', 'C4 Cactus', 'C4 Picasso', 'C5', 'C5 Aircross', 'C5X', 'C6', 'C8', 'Cx', 'DS 3 Crossback', 'DS 4 Crossback', 'DS 7 Crossback', 'DS3', 'DS4', 'DS5', 'DS7', 'Ds', 'E-Mehari', 'Evasion', 'Grand C4 Picasso', 'Gsa', 'Gx', 'Ln', 'Nemo', 'Oltcit', 'Saxo', 'Spacetourer', 'Visa', 'Xantia', 'Xm', 'Xsara', 'Xsara picasso', 'Zx'],
    ...
    'Gonow': ['Gonow'],
    'Great Wall': ['Haval H2', 'Haval H6', 'Hover Cuv', 'Hover H5', 'Hover H6', 'Safe', 'Steed 3', 'Steed 5', 'Steed 6', 'Steed 7', 'Voleex C10', 'Voleex C20', 'Voleex C30'],
    'Haval': ['F7x', 'H2', 'H6', 'Jolion'],
    'Heinkel': ['Тrojan'],
    ...
    'Jpx': ['Montez'],
    'Kia': ['Avella delta', 'Cadenza', 'Carens', 'Carnival', 'Ceed', 'Cerato', 'Clarus', 'EV6', 'Forte', 'Joecs', 'Joyce', 'K5', 'K7', 'K9', 'Magentis', 'Mohave', 'Morning', 'Niro', 'Opirus', 'Optima', 'Picanto', 'Pride', 'Pro ceed', 'Quoris', 'Ray', 'Retona', 'Rio', 'Sedona', 'Sephia', 'Shuma', 'Sorento', 'Soul', 'Spectra', 'Sportage', 'Stinger', 'Stonic', 'Telluride', 'Venga', 'Visto', 'X-Trek', 'XCeed'],
    ...
    'Lincoln': ['Continental', 'Ls', 'MKC', 'MKS', 'MTK', 'Mark', 'Mark Lt', 'Mark lt', 'Mkx', 'Mkz', 'Navigator', 'Town car', 'Zephyr'],
    ...
    'Nissan': ['100 nx', '200 sx', '240 z', '280 z', '300 zx', '350z', '370Z', 'Acura', 'Almera', 'Almera tino', 'Altima', 'Ariya', 'Armada', 'Bluebird', 'Cedric', 'Cherry', 'Cube', 'Figaro', 'Frontier', 'Gt-r', 'Juke', 'Kubistar', 'Laurel', 'Leaf ', 'Maxima', 'Micra', 'Murano', 'NP300', 'Navara', 'Note', 'Pathfinder', 'Patrol', 'Pickup', 'Pixo', 'Prairie', 'Primera', 'Pulsar', 'Qashqai', 'Quest', 'Rogue', 'Sentra', 'Serena', 'Silvia', 'Skyline', 'Stantza', 'Sunny', 'Teana', 'Terrano', 'Tiida', 'Titan crew cab', 'Titan king', 'Versa', 'X-trail', 'Xterra', 'e-NV200'],
    ...
    'Volga': ['22', '24', '3102', '3110', '3111', 'M 20', 'M 21', 'Siber'],
