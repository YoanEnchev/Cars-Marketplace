            ...
            <form method='GET' action=''>
                <div className="row">
                    <div className="col-6 col-md-3">
                        ...
                        <select className="form-select form-select-sm" name="make" id="make">
                    ...
                    <div className="col-6 col-md-3">
                        ...
                        <select className="form-select form-select-sm" name="model" id="model">
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                    ...
                    <div className="col-6 col-md-3">
                        ...
                        <select className="form-select form-select-sm" name="region" id="region">
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                    ...
                    <div className="col-6 col-md-3">
                        ...
                        <select className="form-select form-select-sm" name="subregion" id="subregion">
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                ...
                <div className="row mt-3">
                    <div className="col-6 col-md-3">
                        ...
                        <input className="form-control form-control-sm" type="number" id="max_price" min="0" max="10000000"/>
                    </div>
                    <div className="col-6 col-md-3">
                        <label htmlFor="year" className="mb-2">Година</label>
                        <select className="form-select form-select-sm" name="year" id="year">
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                    ...
                    <div className="col-12 col-md-6">
                        ...
                        <select className="form-select form-select-sm" name="order-by" id="order-by">
                ...
                <div className="row mt-3">
                    <div className="col-6 col-md-3">
                        ...
                        <select className="form-select form-select-sm" name="engine_type" id="engine-type">
                    ...
                    <div className="col-6 col-md-3">
                        ...
                        <select className="form-select form-select-sm" name="gearbox" id="gearbox">
