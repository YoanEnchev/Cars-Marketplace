...
export default function Paginator({totalPages, currentPage, onPageChange}) {
    ...
    let leftPages = [] // Pages from the left of active page (like 1 and 2 when active page is 3).
    let rightPages = [] // Pages from the right of active page (like 4 and 5 when active page is 3).
    ...
    return <nav aria-label="Page navigation example">
        <ul className="pagination">
            ...
            {leftPages.map(page => (<li className="page-item" key={page} onClick={() => onPageChange(page)}>
            ...
            {rightPages.map(page => (<li className="page-item" key={page} onClick={() => onPageChange(page)}>
                <a className="page-link">{page}</a>
            </li>))}
